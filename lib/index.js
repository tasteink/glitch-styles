...
const glitchStyles = {
  boxShadow: `-${GLITCH_LEFT} -${GLITCH_VERTICAL_OFFSET_LEFT} 0px ${COLOR0}, ${GLITCH_RIGHT} ${GLITCH_VERTICAL_OFFSET_RIGHT} 0px ${COLOR1}`,
  textShadow: `-${GLITCH_LEFT} -${GLITCH_VERTICAL_OFFSET_LEFT} 0px ${COLOR0}, ${GLITCH_RIGHT} ${GLITCH_VERTICAL_OFFSET_RIGHT} 0px ${COLOR1}`,
};
